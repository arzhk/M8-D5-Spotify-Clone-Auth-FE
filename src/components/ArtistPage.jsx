        ...
        >
          <div className="container albums-container">
            ...
            <div id="artist-album-row" className="row mb-4">
              {/* Generate cards here  */}
              <div
                className="right-wrapper col d-flex flex-column justify-content-center align-items-start mt-3 mb-5"
            ...
            <div id="artist-album-row" className="row">
              ...
              {albums &&
                albums.length > 1 &&
                albums.map((album, index) => <HomeAlbumCard key={index} album={{ album: album }} />)}
            </div>
            <div className="container albums-container mt-5">
              <h2>Related Artists</h2>
              <div id="artist-album-row" className="row">
                {/* Generate cards here  */}
                <div className="right-wrapper col d-flex flex-column justify-content-center align-items-start">
