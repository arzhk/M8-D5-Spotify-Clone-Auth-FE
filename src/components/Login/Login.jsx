      ...
      <Container fluid>
        <div className="wrapper">
          ...
          <form>
            <Row>
              <Col xs={12} className="button-wrapper">
                <label for="Email1" style={{ fontWeight: 700 }}>
            ...
            <Row>
              <Col className="button-wrapper">
                <label for="InputPassword1" style={{ fontWeight: 700 }}>
                  Password
                </label>
                <input type="password" className="form-control" id="InputPassword1" placeholder="Password" required />
              </Col>
            </Row>
            <Row style={{ padding: 0 }}>
              <Col xs={12}>
