...
import "./Login.css";
import { checkLoginHandler } from "../checkLogin";
...
export const Login = (props) => {
  ...
  const updateInputDataHandler = (event) => {
  ...
  return (
    <>
      <Container fluid className="text-center logo">
        <svg
          style={{ width: 200, height: 66.66, margin: "0 auto" }}
          viewBox="0 0 63 20"
      ...
      <Container fluid>
        <div className="wrapper">
          <Row>
            <Col xs={12} className="text-center mx-auto my-auto">
              <h1 style={{ fontSize: 16, fontWeight: 700 }}>to continue, log in to spotify</h1>
            </Col>
            <Col xs={12} className="d-none error_container" id="error-div">
              <p className="error_msg">Incorrect username or password</p>
            </Col>
            <Col xs={12} className="button-wrapper">
              <a
                className="btn btn-primary d-flex justify-content-center align-items-center w-100 button-fb"
                href="#"
                role="button"
              >
                <i className="fab fa-facebook" id="fab-icon"></i>CONTINUE WITH FACEBOOK
              </a>
            </Col>

            {/* <Col xs={12} className="button-wrapper">
              <a
                className="btn btn-primary d-flex justify-content-center align-items-center w-100 button-ap"
                href="#"
                role="button"
              >
                <span className="mb-0">
            ...
            <Col xs={12} className="button-wrapper">
              <a
                className="btn btn-primary d-flex justify-content-center align-items-center w-100 button-gg"
                href="#"
                role="button"
              >
            ...
            <Col xs={12} className="button-wrapper">
              <a
                className="btn btn-success d-flex justify-content-center align-items-center w-100 button-sp"
                href="#"
                role="button"
              >
                <i className="fab fa-spotify" id="fab-icon"></i>CONTINUE WITH SPOTIFY
              </a>
            </Col>
          </Row>
          <Row>
          ...
          <form onSubmit={(event) => loginHandler(event)}>
            <Row>
              <Col xs={12} className="button-wrapper">
                <label htmlFor="Email1" style={{ fontWeight: 700 }}>
                ...
                <input
                  ...
                  onChange={(event) => updateInputDataHandler(event)}
                  required
                />
              </Col>
            </Row>
            <Row>
              <Col className="button-wrapper">
                <label htmlFor="InputPassword1" style={{ fontWeight: 700 }}>
                  Password
                </label>
                <input
                  type="password"
            ...
            <Row style={{ padding: 0 }}>
              <Col xs={12}>
                <p style={{ margin: "8px 0px 16px" }}>
                  <a className="password-rem" href="#" style={{ textDecoration: "underline" }}>
            ...
            <div className="w-100 d-flex justify-content-between align-items-center">
              <label className="checkwrapper mb-0" style={{ fontSize: 16 }}>
                Remember me
                <input type="checkbox" />
                <span className="checkmark" style={{ border: "1px solid #15883e", borderRadius: 3 }}></span>
              </label>
              <button type="submit" className="btn log-in-btn" id="submit">
                LOG IN
              </button>
            </div>
          </form>

          <div className="sign-up" style={{ padding: 0 }}>
            <Row>
              <Col xs={12}>
                <div className="divider"></div>
              </Col>
            </Row>
            <h6 className="font-weight-bold text-center text-dark my-4">Don't have an account?</h6>
            <Row>
              <Col xs={12}>
                <Link to="/register" className="btn btn-primary w-100 button-link" role="button">
                  SIGN UP FOR SPOTIFY
                </Link>
              </Col>
            </Row>
